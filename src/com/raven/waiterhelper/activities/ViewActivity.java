...
public class ViewActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//populate the page with the patron table
		 populate();
	...
	private void populate() {
		...
		ArrayList<Patron> patronList = patronConverter.convertToPatron();
		 ListView patronListView = (ListView) findViewById(R.id.patronList);
